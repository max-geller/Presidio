...
describe('app', () => {
    ...
    it('should generate files', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(tree.readContent('apps/my-node-app/src/main.ts')).toContain(`await NestFactory.create(AppModule);`);
        expect(tree.exists('apps/my-node-app/src/app/app.module.ts')).toBeTruthy();
    }));
    it('should have es2015 as the tsconfig target', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', { name: 'myNodeApp' }, appTree);
